...
class Model(object):
    ...
    def build_graph(self, data_paths, batch_size, max_time, is_training):
        ...
        loss_updates, loss_op = util_loss(loss_value)
...
def util_read_examples(input_files, batch_size, shuffle, num_epochs=None):
...
def util_accuracy(logits, labels):
